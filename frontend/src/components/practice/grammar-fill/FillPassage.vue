<!-- 语法填空文章(任务书 10.10):全文 + 空位槽;空位显示编号/已填文本;批改态绿勾 / 红叉 -->
<template>
  <div class="fill-passage">
...
.fill-blank.is-active {
  border-style: solid;
  border-color: var(--lc-primary);
  background-color: var(--lc-primary-soft);
}

.fill-blank.is-filled {
  border-style: solid;
  color: var(--lc-text-1);
}

.fill-blank.is-correct {
  border-style: solid;
...
.fill-blank__mark.is-correct {
  color: var(--lc-success);
}

.fill-blank__mark.is-wrong {
  color: var(--lc-error);
}
